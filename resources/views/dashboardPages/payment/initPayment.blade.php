                                ...
                                <div class="col-md-6 col-md-offset-3">
                                    <div class="panel panel-default credit-card-box">
                                        <div class="panel-body">
                                            ...
                                            <form role="form" action="{{ route('Dashboard.paymentProcess') }}" method="post" class="require-validation"
...
$(function() {
  ...
  function stripeResponseHandler(status, response) {
        if (response.error) {
            ...
            $form.append("<input type='hidden' name='screenVisitId' value='{{$screen_visit_id}}'/>");
