	...
	<div class="p-3 p-md-4">
		<div class="wrapper">
			<div class="wrapper-title">
				<span>Invite Medical Monitor</span>
				<a href="{{route('Dashboard.MM.getMMList')}}" class="btn btn-secondary btn-wide">Back</a>
			</div>
			<div class="card">
				<div class="card-body">
					<div class="p-xl-5 container">
						...
						@endif
						<form class="form mt-4" action="{{route('Dashboard.MM.insertMM')}}" method="post" enctype="multipart/form-data">
							@csrf
							...
							<div class="row">
								...
								<div class="col-12 text-center mt-4">
									<button type="submit" class="btn btn-orange btn-wide">Invite Medical Monitor</button>
								</div>
							</div>
						</form>
					</div>
