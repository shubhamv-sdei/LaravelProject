					...
					<!-- <div class="col-md-4">
						<div class="profile_status">
							...
							<ul>
								...
								<li>
									<button class="btn btn-round btn-primary">Dashboard <em
				...
				<div class="row">
					<div class="col-md-5">
						<div class="profile_left">
							<h4>About me</h4>
							<div class="card">
								<p><a href="{{route('Dashboard.profile.edit')}}" class="text-right">Edit</a></p>
								<table class="table">
									<tbody>
										<tr>
											<td>First Name:</td>
					...
					<div class="col-md-7">
						<div class="profile_right">
							...
							<div class="card">
								@if(count($data))
								<p><a href="{{route('Dashboard.professionalInfo.edit')}}" class="text-right">Edit</a></p>
								@else
								<p><a href="{{route('Dashboard.professionalInfo.edit')}}" class="text-right">Click Here to add above</a></p>
								@endif
								@if(Auth::user()->role == 1)
									<table class="table">
										<tbody>
											...
											<tr>
											<td>Are you currently conducting a clinical trial?</td>
												<td class="text-secondary">
...
Are you currently conducting a clinical trial?</td>
								...
								<div class="mt-3 text-right">
									<a href="{{route('Dashboard.professionalInfo.edit')}}" class="btn btn-orange btn-wide">EDIT</a>
								</div>
								@else
								<div class="mt-3 text-right">
									<a href="{{route('Dashboard.professionalInfo.edit')}}" class="btn btn-orange btn-wide">Click Here to add above info.</a>
								</div>
								@endif
							</div>
						</div>
