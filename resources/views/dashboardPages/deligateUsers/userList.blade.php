			...
			<div class="wrapper">
				<div class="wrapper-title">
					...
					<div class="col-md-6 col-lg-8 text-md-right">
						<button type="button" class="btn btn-secondary btn-wide"><a href="{{route('Dashboard.DeligateUser.addDeligateUser')}}" style="color:white;">Invite Staff</a></button>
					</div>
				</div>
				<div class="card">
					<div class="card-body">
...
<script>
	...
	function DeleteUser(id){
		...
		function(isConfirm) {
		  if (isConfirm) {
            $.ajax({
              url:"{{url('/dashboard/deligateUser/deleteUsers/')}}/"+id,
              method:"GET",
              success:function(data){
               	// swal("Un-Assigned!", "Un-Assigned Investigator Successfully.", "success"); 
               	swal({
